...
describe('PolicyDataComponent', () => {
  let component: PreviewPolicyDataComponent;
  let fixture: ComponentFixture<PreviewPolicyDataComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [],
      providers: [ PreviewPolicyDataComponent ,
        {
          provide: MatDialog,
    ...
    component = TestBed.inject(PreviewPolicyDataComponent);
  });
