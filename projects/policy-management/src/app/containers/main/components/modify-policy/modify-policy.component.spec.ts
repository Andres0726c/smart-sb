...
describe('ModifyPolicyComponent', () => {
  ...
  it('transformData', () => {
    let a ={plcyDtGrp:{id: 1,name: "Datos básicos",code: "datos_basicos",fields: [{id: 67,code: { businessCode: "FEC_INI_VIG_POL", version: 1 }}]}}
    component.policy = {plcy: {plcyDtGrp: {id: 1,name: "Datos básicos",code: "datos_basicos",},risk: {rskDtGrp: {}}}};
