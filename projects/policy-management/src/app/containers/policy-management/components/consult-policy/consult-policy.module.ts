...
import { ModalRenewalModule } from 'projects/policy-management/src/app/containers/policy-management/components/consult-policy/modal-renewal/modal-renewal.module';
